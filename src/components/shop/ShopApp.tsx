          ...
          <div className="flex items-center gap-1 overflow-x-auto">
            {tabs.map(tab => (
              <button
                ...
                className={`relative flex items-center gap-2 px-3 md:px-4 py-5 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === tab.id ? "text-primary" : "text-muted-foreground hover:text-foreground"}`}
              >
