...
import { LayoutDashboard, Users, ShoppingCart, Package, Settings, ChevronDown, LogOut, Shield, User } from "lucide-react";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuTrigger } from "@/components/ui/dropdown-menu";
import kvadredLogo from "@/assets/kvadred-logo.png";
import ShopOverview from "./ShopOverview";
import ShopDesigners from "./ShopDesigners";
...
export default function ShopApp() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "designers": return <ShopDesigners />;
      case "sales": return <ShopSales />;
          ...
          <div className="flex items-center gap-1 overflow-x-auto">
            {tabs.map(tab => (
              <button
                ...
                className={`relative flex items-center gap-2 px-3 md:px-4 py-5 text-sm font-medium transition-colors whitespace-nowrap ${activeTab === tab.id ? "text-primary" : "text-secondary-alpha hover:text-foreground"}`}
              >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52">
              <div className="px-3 py-2">
                ...
                <p className="text-xs text-secondary-alpha">Магазин</p>
              </div>
