...
const problemCards = [
  {
    ...
    problems: [
      "Budget surprises derailing your project?",
      "Unsure what to expect or when?",
      "Overwhelmed by tracking every detail?"
    ]
  },
  {
    icon: Palette,
    ...
    problems: [
      "Spending hours on estimates?",
      "Struggling to communicate timelines?",
      "Manual material calculations eating your time?"
    ]
  },
  {
    icon: Wrench,
    ...
    problems: [
      ...
      "Lost track of materials and suppliers?"
    ]
  }
];
...
const solutionCards = [
  {
    ...
    desc: "Instant cost and time estimates based on real data"
  },
  {
    icon: Palette,
    title: "Professional Design Tools",
    desc: "Templates and material libraries at your fingertips"
  },
  {
    icon: BarChart3,
    title: "Complete Project Management",
    desc: "Track teams, clients, and inventory in one place"
  }
];

const testimonials = [
  { name: "Sarah Chen", role: "Interior Designer", text: "RenoPlan cut my estimate time by 70%. My clients love the transparency.", avatar: "SC" },
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <motion.p variants={fadeUp} custom={1} className="mb-8 text-primary-foreground/80">No credit card required</motion.p>
